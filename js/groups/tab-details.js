  ...
  container.innerHTML = `
    <section class="card">
      <div style="display:flex; justify-content:space-between; align-items:center;">
        <h3>Group Details</h3>
        <div>
          ${portalState.canEdit ? `<button id="btnSaveGroup" class="btn-primary">Save</button>` : ``}
          ${portalState.deleteAllowed ? `<button id="btnDeleteGroup" class="btn-danger">Delete</button>` : ``}
        </div>
      </div>
      <div class="notes-row">
