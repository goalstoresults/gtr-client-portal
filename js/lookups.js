// js/lookups.js v1.0.1
// Lookups tab with full Worker URLs
  ...
  try {
    ...
    groupsDiv.addEventListener("click", async e => {
      ...
      if (e.target.classList.contains("editBtn")) {
        ...
        if (!newVal) return;
        await fetch(`https://lookups-module.dennis-e64.workers.dev/lookups/edit/${row.dataset.id}`, {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
      ...
      if (e.target.classList.contains("deleteBtn")) {
        ...
        await fetch(`https://lookups-module.dennis-e64.workers.dev/lookups/delete/${row.dataset.id}`, {
          method: "DELETE"
        });
        loadLookupsTab({ portalState, tabContent });
      }
